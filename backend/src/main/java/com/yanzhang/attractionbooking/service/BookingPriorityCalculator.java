...
@Component
public class BookingPriorityCalculator {

    public static final String RULE_VERSION = "rome-official-policy-v1";

    private final Clock clock;

    public BookingPriorityCalculator() {
        this(Clock.systemUTC());
    }

    public BookingPriorityCalculator(Clock clock) {
        this.clock = clock;
    }

    public BookingPriorityAssessment assess(OfficialBookingEvidence evidence) {
