...
import com.yanzhang.attractionbooking.attraction.internal.places.GooglePlaceDtos;
import com.yanzhang.attractionbooking.attraction.internal.places.GooglePlacesClient;
import com.yanzhang.attractionbooking.attraction.internal.places.GooglePlacesClientException;
...
@Service
public class RomePlaceQueryService {
    ...
    @Autowired
    public RomePlaceQueryService(Optional<GooglePlacesClient> client) {
        this(client, Clock.systemUTC());
    }

    public RomePlaceQueryService(Optional<GooglePlacesClient> client, Clock clock) {
        this.client = client;
        this.clock = clock;
    }

    public List<RomePlaceEvidence> fetchVerifiedPlaces() {
    ...
    public record RomePlaceEvidence(
            String attractionId,
            String componentId,
            String placeId,
            String name,
