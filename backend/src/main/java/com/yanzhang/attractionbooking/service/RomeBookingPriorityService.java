...
@Service
public class RomeBookingPriorityService implements RomeBookingPriorityQuery {

    private static final long MAXIMUM_STAY_DAYS = 31;

    private final RomeOfficialBookingEvidenceRepository repository;
    private final BookingPriorityCalculator calculator;

    public RomeBookingPriorityService(
            RomeOfficialBookingEvidenceRepository repository,
