...
本轮只核对了 Provider 的官方公开资料，没有注册合作伙伴账号、提交申请或获取 API key。因此，下面的结论用于决定申请顺序，不能视为已经取得数据使用权限。
...
下一次更新应在提交第一份 Provider 申请或收到正式答复后进行。未知项目继续保持“待确认”，不能根据营销描述自行推断。
